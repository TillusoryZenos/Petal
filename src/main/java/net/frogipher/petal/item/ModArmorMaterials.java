...
{
    FLOWER_CROWN("flower_crown", 5, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
        map.put(ArmorItem.Type.BOOTS, 1);
        map.put(ArmorItem.Type.LEGGINGS, 2);
        map.put(ArmorItem.Type.CHESTPLATE, 3);
        map.put(ArmorItem.Type.HELMET, 5);
    }), 15, SoundEvents.BLOCK_AZALEA_LEAVES_PLACE, 0.0f, 0.0f, () -> Ingredient.ofItems(Items.POPPY));
    ...
    public String getName() {
        return PetalMod.MOD_ID + ":" + this.name;
    }
